...
import MovieGridServer from '@/components/MovieGrid.server';
...
interface MovieQueryResultsClientProps{
    loading: boolean
    listResponse?: TMDBListResponse
}
            ...
            <PaginationProvider>
                ...
                <section className='flex flex-col flex-1 min-h-0 w-full'>
                    <Suspense fallback={<MovieGridSkeleton />}>
                        <MovieGridServer resultsPromise={resultsPromise} />
                    </Suspense>
                </section>
